         ...
         echo '</tr>';
             foreach($params as $param){
                        echo '<tr>';
                            ...
                            echo '<td class="save-btn hide"><a class="input-action save-param-input" tank_id="'.$tank_id.'" nonce="'. wp_create_nonce("ajax_form_nonce_save_param").'"><i class="fas ia-icon fa-save"></i></a></td>';
